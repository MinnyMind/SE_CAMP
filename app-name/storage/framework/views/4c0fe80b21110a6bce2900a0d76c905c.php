                                ...
                                <tbody>
                                    <?php foreach($titles as $index => $titles) {?>
                                        <tr>
                                            ...
                                            <td><?php echo e($titles->tit_name); ?></td>
                                            <td>
                                              <?php echo e($titles->tit_is_active); ?>

                                            </td>
                                            <td>
                                                <a href="<?php echo e(url('/titles/'.$titles->tit_id)); ?>"
...
<?php echo $__env->make('layouts.defualt', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/SE_CAMP/app-name/resources/views/titles/index.blade.php ENDPATH**/ ?>